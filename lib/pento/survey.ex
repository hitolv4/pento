defmodule Pento.Survey do
  ...
  def get_demographics_by_user(user) do
  ...
  def update_rating(%Rating{} = demographic, attrs) do
    demographic
    |> Rating.changeset(attrs)
    |> Repo.update()
  end

  def delete_rating(%Rating{} = demographic) do
    Repo.delete(demographic)
  end

  def change_rating(%Rating{} = demographic, attrs \\ %{}) do
    Rating.changeset(demographic, attrs)
  end
end
