defmodule Pento.FAQ do
  ...
  @doc """
  Returns the list of frequently_asked_question.

  ## Examples

      iex> list_frequently_asked_question()
      [%FrequentlyAskedQuestion{}, ...]

  """
  def list_frequently_asked_question do
    Repo.all(from q in FrequentlyAskedQuestion, order_by: [asc: q.id])
  end
  ...
  def create_frequently_asked_question(attrs \\ %{}) do
    %FrequentlyAskedQuestion{}
    |> FrequentlyAskedQuestion.changeset_question(attrs)
    |> Repo.insert()
  end
  ...
  """
  def update_frequently_asked_question(
  ...
  def update_answer(
    ...
    frequently_asked_question
    |> FrequentlyAskedQuestion.changeset_answer(attrs)
    |> Repo.update()
  end
  ...
  def update_vote(
    ...
    frequently_asked_question
    |> FrequentlyAskedQuestion.changeset_vote(attrs)
    |> Repo.update()
  end
  ...
  """
  def change_frequently_asked_question(
        %FrequentlyAskedQuestion{} = frequently_asked_question,
        attrs \\ %{}
      ) do
  ...
  def change_question(%FrequentlyAskedQuestion{} = frequently_asked_question, attrs \\ %{}) do
    FrequentlyAskedQuestion.changeset_question(frequently_asked_question, attrs)
  end

  def change_answer(%FrequentlyAskedQuestion{} = frequently_asked_question, attrs \\ %{}) do
    FrequentlyAskedQuestion.changeset_answer(frequently_asked_question, attrs)
  end
end
